...
- **Этап:** Планирование завершено ✅ | Этап 1 готов к старту
- **Прогресс:** 0/21 задач выполнено (0%)
- **Текущая задача:** Создание roadmap_lite.md
- **Блокеры:** Нет

### Прогресс по этапам:
- ⏳ **Этап 1:** Создание структуры lite/ (0/6 задач)
...
### Этап 1: Создание структуры lite/ ⏳

**Цель:** Создать базовую структуру проекта Lite версии

**Задачи:**

- [ ] **1.1** Создать папку `lite/` в корне проекта (5 мин)
  - Путь: `/Users/mactm/Projects/electron_prototype/lite/`
  - Команда: `mkdir lite`

- [ ] **1.2** Создать `lite/package.json` (10 мин)
  ```json
  {
    "name": "ecu-tuner-lite",
    "version": "0.1.0-lite",
...
- [ ] **1.3** Создать `lite/tsconfig.json` (5 мин)
  ```json
  {
    "compilerOptions": {
      "target": "ES2020",
...
- [ ] **1.4** Создать папку `lite/web/` (5 мин)
  - Команда: `mkdir lite/web`
  - Эта папка будет содержать frontend файлы

- [ ] **1.5** Создать `lite/.gitignore` (2 мин)
  ```
  node_modules/
  dist/
  *.log
...
- [ ] **1.6** Установить зависимости (5 мин)
